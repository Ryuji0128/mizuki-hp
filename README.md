...
**Fusetsu HP** は、みずきクリニックのホームページ作成に係るプロジェクトとして、[Next.js_v15](https://nextjs.org/) をベースに構築し、App Routerを搭載。また、React、MUIを中心とした、最新のフロントエンド技術を活用。

## 目次

- [Fusetsu HP（みずきクリニック ホームページ）](#fusetsu-hpみずきクリニック-ホームページ)
  - [概要](#概要)
  - [目次](#目次)
  - [インストール](#インストール)
  - [使用方法](#使用方法)
...
このプロジェクトのライセンスは、みずきクリニックに帰属します。
